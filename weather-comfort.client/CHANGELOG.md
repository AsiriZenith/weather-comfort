...
- Create Angular project with ng: `ng new weather-comfort.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`weather-comfort.client.esproj`).
